...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-200 font-sans pb-20 transition-colors duration-300">
      {/* HEADER */}
      <header className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 sticky top-0 z-20 shadow-sm transition-colors duration-300">
        <div className="max-w-6xl mx-auto px-6 h-16 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold tracking-tight text-slate-900 dark:text-white hidden sm:block">I Miei Ristoranti</h1>
          </div>
          <div className="flex items-center gap-4">
            ...
            <div className="relative" ref={dropdownRef}>
              <button 
                ...
                className="flex items-center gap-2 p-1 pl-3 bg-slate-50 dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-700 rounded-full transition-colors group"
              >
                <span className="text-sm font-bold text-slate-600 dark:text-slate-300 hidden sm:block">{user?.email?.split('@')[0]}</span>
      ...
      <main className="max-w-6xl mx-auto px-6 py-10 flex flex-col lg:flex-row gap-8 items-start">
        ...
        <div className="flex gap-6 mb-8 border-b border-slate-200 dark:border-slate-700">
          <button 
            ...
            className={`pb-4 font-bold text-sm px-2 transition-colors relative ${activeTab === 'menus' ? 'text-indigo-600 dark:text-indigo-400' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'}`}
          >
            I Miei Menù
          ...
          <button 
            ...
            className={`pb-4 font-bold text-sm px-2 transition-colors relative flex items-center gap-1.5 ${activeTab === 'analytics' ? 'text-indigo-600 dark:text-indigo-400' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'}`}
          >
          ...
          <button 
            ...
            className={`pb-4 font-bold text-sm px-2 transition-colors relative flex items-center gap-1.5 ${activeTab === 'reviews' ? 'text-indigo-600 dark:text-indigo-400' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'}`}
          >
          ...
          <button 
            ...
            className={`pb-4 font-bold text-sm px-2 transition-colors relative flex items-center gap-1.5 ${activeTab === 'orders' ? 'text-indigo-600 dark:text-indigo-400' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'}`}
          >
        ...
        <div className="flex gap-4 mb-10 overflow-x-auto pb-4 hide-scrollbar">
           <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-sm min-w-[200px] flex-1 transition-colors">
        ...
        {/* LISTA MENU */}
        {menus.length === 0 ? (
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[32px] p-16 text-center shadow-sm relative overflow-hidden transition-colors">
        ...
        <aside className="w-full lg:w-80 shrink-0 flex flex-col gap-6">
          ...
          <div className="bg-gradient-to-br from-indigo-600 to-purple-700 rounded-3xl p-6 text-white shadow-xl shadow-indigo-500/20 relative overflow-hidden group">
            ...
            <h3 className="font-black text-xl mb-2 flex items-center gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>
              Passa a Premium
            </h3>
            <p className="text-sm text-indigo-100 mb-6 font-medium leading-relaxed">
              Sblocca analytics avanzate, pagamenti integrati con Stripe e supporto prioritario.
            </p>
            <button className="w-full bg-white text-indigo-700 font-bold py-3 px-4 rounded-xl flex justify-center items-center gap-2 hover:bg-slate-50 transition-colors shadow-sm">
              Scopri i Piani
          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-sm transition-colors">
            ...
            <div className="space-y-3">
              <a href="#" className="flex items-center gap-3 text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 p-2 hover:bg-indigo-50 dark:hover:bg-indigo-500/10 rounded-xl transition-colors">
                <div className="w-8 h-8 rounded-lg bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-400">
                   <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" x2="8" y1="13" y2="13"/><line x1="16" x2="8" y1="17" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
                </div>
                Documentazione API
              </a>
              <a href="#" className="flex items-center gap-3 text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-teal-600 dark:hover:text-teal-400 p-2 hover:bg-teal-50 dark:hover:bg-teal-500/10 rounded-xl transition-colors">
                 <div className="w-8 h-8 rounded-lg bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-400">
