              ...
              <section>
                ...
                <div className="bg-white rounded-3xl border border-[#2D2016]/10 shadow-sm overflow-hidden">
                  ...
                  <div className="divide-y divide-slate-100">
                    {items.map((item) => (
                      <div key={item.id} className="p-5 sm:p-6 flex flex-col md:flex-row gap-4 items-start md:items-center hover:bg-[#FAF8F5]/50 transition-colors group">

                        {/* Foto Piatto */}
                        <div className="relative shrink-0">
                          <div
                            onClick={() => !item.image && triggerItemImageUpload(item.id)}
                            className={`w-16 h-16 bg-slate-100 rounded-2xl overflow-hidden flex items-center justify-center border border-[#2D2016]/10 transition-colors ${!item.image ? 'cursor-pointer hover:border-teal-500 group-hover:shadow-sm' : ''}`}
                          >
                            {item.image ? (
                          ...
                          {item.image && (
                            <button
                              ...
                              className="absolute -top-2 -right-2 bg-rose-500 hover:bg-rose-600 text-[#F5F0E8] rounded-full p-1 shadow-md transition-transform hover:scale-110 flex items-center justify-center w-6 h-6 cursor-pointer"
                              title="Rimuovi foto"
                            >
                          ...
                          {item.showAdvanced && (
                            <div className="pt-3 pb-1 border-t border-slate-100 mt-2 space-y-4 animate-in fade-in slide-in-from-top-2">
                              ...
                              <div className="flex flex-wrap items-center gap-1.5 mt-2">
                                <span className="text-[9px] bg-emerald-500 text-[#F5F0E8] font-black px-1.5 py-0.5 rounded uppercase tracking-widest shadow-sm mr-1">Beta Free</span>
                                {DIETARY_OPTIONS.map(opt => {
                                  ...
                                  return (
                                    <button
                                      ...
                                      className={`inline-flex items-center gap-1 px-2 py-1 rounded-lg text-[10px] font-bold transition-all border ${isActive ? 'bg-teal-50 text-teal-700 border-teal-200' : 'bg-[#FAF8F5] text-slate-400 border-slate-100 hover:border-slate-300'}`}
                                    >
                                ...
                                {BADGE_OPTIONS.map(opt => {
                                  ...
                                  return (
                                    <button
                                      ...
                                      className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-lg text-[10px] font-bold transition-all border ${isActive ? opt.color : 'bg-[#FAF8F5] text-slate-400 border-slate-100 hover:border-slate-300'}`}
                                    >
                                      {opt.label}
                                    </button>
                                  );
                              ...
                              <div className="mt-2">
                                <input
                                  ...
                                  className="text-[11px] text-slate-400 px-1 font-medium w-full bg-transparent border-b border-transparent hover:border-[#2D2016]/10 focus:border-amber-500 focus:bg-white rounded outline-none transition-colors"
                                    ...
                                    {item.variants.map((v, vi) => (
                                      <div key={vi} className="flex items-center gap-2">
                                        <input
                                          ...
                                          className="w-24 px-2 py-1 border border-[#2D2016]/10 rounded-lg text-[11px] font-bold bg-[#FAF8F5] focus:bg-white outline-none focus:ring-1 focus:ring-amber-500"
                                        ...
                                        <div className="relative">
                                          ...
                                          <input
                                            ...
                                            className="w-20 pl-6 pr-2 py-1 border border-[#2D2016]/10 rounded-lg text-[11px] font-bold bg-[#FAF8F5] focus:bg-white outline-none focus:ring-1 focus:ring-amber-500"
                                          />
                                        </div>
                                        <button
                                          type="button"
                        ...
                        <div className="flex items-center gap-4 w-full md:w-auto shrink-0 justify-between md:justify-end border-t md:border-none pt-4 md:pt-0 border-slate-100">
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-24 pl-7 pr-3 py-2 border border-[#2D2016]/10 rounded-xl text-slate-900 font-bold bg-[#FAF8F5] focus:bg-white focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all"
                            />
                          </div>
                          <button
                            onClick={() => handleDelete(item.id)}
                            className="p-2.5 bg-white border border-[#2D2016]/10 text-slate-400 hover:text-rose-500 hover:border-rose-200 hover:bg-rose-50 rounded-xl transition-colors shadow-sm"
                          >
                  ...
                  <div className="bg-[#FAF8F5] p-6 border-t border-[#2D2016]/10">
                    <h4 className="text-xs font-bold text-[#2D2016] uppercase tracking-widest mb-4 flex items-center gap-2">
                      ...
                      <div className="md:col-span-2 flex items-center gap-4">
                        <div className="relative shrink-0">
                          <div
                            ...
                            className={`w-12 h-12 bg-slate-200 rounded-xl overflow-hidden flex items-center justify-center transition-colors ${!newItem.image ? 'cursor-pointer border-2 border-dashed border-slate-300 hover:border-teal-500' : 'border-2 border-[#2D2016]/10'}`}
                          >
                            {newItem.image ? (
                          ...
                          {newItem.image && (
                            <button
                              ...
                              className="absolute -top-2 -right-2 bg-rose-500 hover:bg-rose-600 text-[#F5F0E8] rounded-full p-1 shadow-md transition-transform hover:scale-110 flex items-center justify-center w-5 h-5 cursor-pointer"
                              title="Rimuovi foto"
                            >
                              <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="3"><path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" /></svg>
                            </button>
                        ...
                        <div className="flex-1">
                          ...
                          <input type="text" value={newItem.name} onChange={e => setNewItem({ ...newItem, name: e.target.value })} className="w-full px-4 py-2.5 border border-[#2D2016]/10 rounded-xl bg-white text-sm font-medium focus:ring-2 focus:ring-teal-500 outline-none" placeholder="Es. Salad" />
                        </div>
                      </div>
                      <div className="md:col-span-1">
                        <label className="text-xs font-bold text-slate-500 block mb-1">CATEGORIA</label>
                        <input type="text" value={newItem.category} onChange={e => setNewItem({ ...newItem, category: e.target.value })} className="w-full px-4 py-2.5 border border-[#2D2016]/10 rounded-xl bg-white text-sm font-medium focus:ring-2 focus:ring-teal-500 outline-none" placeholder="Es. Sides" />
                      </div>
                      <div className="md:col-span-1">
                        <label className="text-xs font-bold text-slate-500 block mb-1">DESCRIZIONE</label>
                        <input type="text" value={newItem.description || ''} onChange={e => setNewItem({ ...newItem, description: e.target.value })} className="w-full px-4 py-2.5 border border-[#2D2016]/10 rounded-xl bg-white text-sm font-medium focus:ring-2 focus:ring-teal-500 outline-none" placeholder="Opzionale.." />
                      </div>
                      <div className="md:col-span-1">
                        <label className="text-xs font-bold text-slate-500 block mb-1">PREZZO ({settings.currency || "€"})</label>
                        <input type="number" step="0.50" value={newItem.price} onChange={e => setNewItem({ ...newItem, price: e.target.value })} className="w-full px-4 py-2.5 border border-[#2D2016]/10 rounded-xl bg-white text-sm font-bold focus:ring-2 focus:ring-teal-500 outline-none" placeholder="0.00" />
                      </div>
                      {/* AVANZATE TOGGLE per NEW ITEM */}
                      <div className="md:col-span-6">
                        <button
                          onClick={() => setNewItem({ ...newItem, showAdvanced: !newItem.showAdvanced })}
                          className="text-sm font-bold text-slate-500 hover:text-slate-700 flex items-center gap-2 py-2 w-full justify-center bg-white hover:bg-[#FAF8F5] rounded-xl border border-[#2D2016]/10 transition-colors shadow-sm mt-2"
                        >
                      ...
                      {newItem.showAdvanced && (
                        <div className="md:col-span-6 grid grid-cols-1 md:grid-cols-5 gap-y-4 gap-x-6 border border-slate-100 rounded-2xl p-5 bg-white shadow-sm mt-2 animate-in fade-in slide-in-from-top-2">
                          <div className="md:col-span-5">
                            <label className="text-xs font-bold text-slate-500 block mb-1">TAG DIETETICI <span className="text-[9px] bg-emerald-500 text-[#F5F0E8] font-black px-1.5 py-0.5 rounded uppercase tracking-widest shadow-sm ml-1">Beta Free</span></label>
                              ...
                              {DIETARY_OPTIONS.map(opt => {
                                ...
                                return (
                                  <button
                                    ...
                                    className={`inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs font-bold transition-all border ${isActive ? 'bg-teal-50 text-teal-700 border-teal-200' : 'bg-[#FAF8F5] text-slate-400 border-slate-100 hover:border-slate-300'}`}
                                  >
                                    <span>{opt.icon}</span> {opt.label}
                                  </button>
                                );
                              ...
                              {BADGE_OPTIONS.map(opt => {
                                ...
                                return (
                                  <button
                                    ...
                                    className={`inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs font-bold transition-all border ${isActive ? opt.color : 'bg-[#FAF8F5] text-slate-400 border-slate-100 hover:border-slate-300'}`}
                                  >
                                    {opt.label}
                                  </button>
                                );
                          ...
                          <div className="md:col-span-5">
                            ...
                            <input type="text" value={newItem.ingredients || ''} onChange={e => setNewItem({ ...newItem, ingredients: e.target.value })} className="w-full px-4 py-2.5 border border-[#2D2016]/10 rounded-xl bg-white text-sm font-medium focus:ring-2 focus:ring-teal-500 outline-none" placeholder="Es. farina, mozzarella, pomodoro, basilico..." />
                          </div>
                          <div className="md:col-span-5">
                            ...
                            {newItem.variants && newItem.variants.length > 0 && (
                              <div className="space-y-1.5 mb-2">
                                {newItem.variants.map((v, vi) => (
                                  <div key={vi} className="flex items-center gap-2">
                                    <input type="text" value={v.name} onChange={(e) => { const nv = [...newItem.variants]; nv[vi] = { ...nv[vi], name: e.target.value }; setNewItem({ ...newItem, variants: nv }); }} className="w-28 px-3 py-2 border border-[#2D2016]/10 rounded-lg text-sm font-bold bg-[#FAF8F5] focus:bg-white outline-none focus:ring-1 focus:ring-amber-500" placeholder="Es. Piccola" />
                                    <div className="relative">
                                      <span className="absolute left-2 top-1/2 -translate-y-1/2 text-slate-400 text-sm font-bold">{settings.currency || "€"}</span>
                                      <input type="number" step="0.50" value={v.price} onChange={(e) => { const nv = [...newItem.variants]; nv[vi] = { ...nv[vi], price: parseFloat(e.target.value) || 0 }; setNewItem({ ...newItem, variants: nv }); }} className="w-24 pl-7 pr-2 py-2 border border-[#2D2016]/10 rounded-lg text-sm font-bold bg-[#FAF8F5] focus:bg-white outline-none focus:ring-1 focus:ring-amber-500" />
                                    </div>
